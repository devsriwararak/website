...
const SpeedDial = () => {
  ...
  return (
    ...
    <div id="speed-dial-menu-default" className={classname(open ? "flex" : "hidden" ," flex-col items-center  mb-4 space-y-2")}>
    ...
    <button onClick={handleClick} type="button" data-dial-toggle="speed-dial-menu-default" aria-controls="speed-dial-menu-default" aria-expanded="false" className="flex items-center justify-center text-white bg-purple-700 rounded-full w-14 h-14 hover:bg-blue-800 dark:bg-purple-600 dark:hover:bg-purple-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-purple-800">
