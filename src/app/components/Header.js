    ...
    <>
      <header
        className={`fixed top-0 w-full transition-colors duration-300 z-50 ${
           pathname === "/" ?  isScrolled ?   "bg-white shadow-lg" : open ? "bg-white  " :  " bg-transparent " : "bg-white shadow-lg"
        } `}
      >
          <div className=" container mx-auto py-3 px-10  lg:px-32  sm:py-5 lg:py-4 w-full ">
        <div className="flex justify-between items-center">
          <Link href="/"><p className={`${ pathname === "/" ? isScrolled ? "text-black " :  open ? "text-black" : "text-white" : "text-black"}  font-semibold `}>DEV SRIWARARAK </p></Link>
          <div className="hidden lg:flex">
            <ul className={`flex flex-row gap-4 items-center cursor-pointer ${pathname === "/" ? isScrolled ? "text-gray-900" : "text-white" : "text-black"}`}>
              
                <li
                  className={` px-2 py-1.5 rounded-lg ${
                     pathname === "/"  ? isScrolled ? "bg-purple-100  ": " bg-purple-100 bg-opacity-50 text-purple-500" : ""
                  }`}
                >
                ...
                <li
                  className={` px-2 py-1.5 rounded-lg ${
                    pathname === "/about"  ? isScrolled ? "bg-purple-100 ": " bg-purple-100 bg-opacity-50 text-purple-500" : ""
                  }`}
                >
              ...
              <Link href="/review">
                <li
                  className={` px-2 py-1.5 rounded-lg ${
                     pathname === "/review"  ? isScrolled ? "bg-purple-100 ": " bg-purple-100 bg-opacity-50 text-purple-500" : ""
                  }`}
                >
                  ผลงาน
                </li>
              ...
              <li
                className={`hover:bg-purple-100 px-2 py-2 rounded-lg ${
                  pathname.startsWith("/blogs") ? isScrolled ? "bg-purple-100 ": " bg-purple-100 bg-opacity-50 text-purple-500"  : ""
                }`}
              >
