...
const data = [
  {
    ...
    discount: "ประหยัด 8%",
    result: [
      { id: 0, status: false, title: "ออกแบบหน้าเว็บ + คอนเฟิร์มแบบ" },
      { id: 1, status: true, title: "ลงสินค้า ตะกร้าสินค้า + บทความ (SEO)" },
      { id: 2, status: false, title: "รองรับการใช้งาน 2 ภาษา TH ENG" },
      { id: 3, status: true, title: "จูน Performance SEO + ความเร็วเว็บ" },
      { id: 4, status: true, title: "ติดตั้ง SSL เพิ่มความปลอดภัย" },
      { id: 5, status: false, title: "ระบบจัดการหลังบ้าน 100%" },
      { id: 6, status: true, title: "ดูกราฟ GSC, GA วิเคาะห์ยอดขาย" },
      { id: 7, status: false, title: "ดูรายงานยอดขายได้" },
      { id: 8, status: true, title: "ใช้งานได้ทุกขนาดหน้าจอ" },
      { id: 9, status: true, title: "ดูแล 6 เดือน - 1 ปี หรือตามตกลง" },
      { id: 10, status: false, title: "คู่มือสอนแก้ไข จุดที่แก้ไขได้เอง" },
      { id: 11, status: true, title: "ต่ออายุ 2,000 บาท/ปี" },
    ],
  },
  {
    id: 1,
    ...
    discount: "ประหยัด 13%",
    result: [
      { id: 0, status: true, title: "ออกแบบหน้าเว็บ + คอนเฟิร์มแบบ" },
      { id: 1, status: true, title: "ลงสินค้า ตะกร้าสินค้า + บทความ (SEO)" },
      { id: 2, status: true, title: "รองรับการใช้งาน 2 ภาษา TH ENG" },
      { id: 3, status: true, title: "จูน Performance SEO + ความเร็วเว็บ" },
      { id: 4, status: true, title: "ติดตั้ง SSL เพิ่มความปลอดภัย" },
      { id: 5, status: true, title: "ระบบจัดการหลังบ้าน 100%" },
      { id: 6, status: true, title: "ดูกราฟ GSC, GA วิเคาะห์ยอดขาย" },
      { id: 7, status: false, title: "ดูรายงานยอดขายได้" },
      { id: 8, status: true, title: "ใช้งานได้ทุกขนาดหน้าจอ" },
      { id: 9, status: true, title: "ดูแล 6 เดือน - 1 ปี หรือตามตกลง" },
      { id: 10, status: true, title: "คู่มือสอนแก้ไข จุดที่แก้ไขได้เอง" },
      { id: 11, status: true, title: "ไม่มีต่ออายุรายปี" },
    ],
  },
  {
    id: 2,
    ...
    result: [
      ...
      { id: 5, status: true, title: "ระบบจัดการหลังบ้าน 100%" },
      { id: 6, status: true, title: "ดูกราฟ GSC, GA วิเคาะห์ยอดขาย" },
      { id: 7, status: true, title: "ดูรายงานยอดขายได้" },
      { id: 8, status: true, title: "ใช้งานได้ทุกขนาดหน้าจอ" },
      { id: 9, status: true, title: "ดูแล 6 เดือน - 1 ปี หรือตามตกลง" },
      { id: 10, status: true, title: "คู่มือสอนแก้ไข จุดที่แก้ไขได้เอง" },
      { id: 11, status: true, title: "ไม่มีต่ออายุรายปี" },
