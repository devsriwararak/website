  ...
  return (
    <div className="  flex flex-col gap-4  ">
      <div className=" border border-gray-100  shadow-lg rounded-lg py-0.5    ">
        <h3 className="mb-0" id="headingOne">
          <button
            className={classname(
              ...
              "group  flex w-full items-center  border-0  px-5 py-4 text-left text-base  transition rounded-md "
            )}
            type="button"
        ...
        >
          <p className="px-0 md:px-5 py-4 text-sm">
      ...
      <div className="border  border-gray-200 rounded-lg py-0.5  shadow-lg  ">
        <h3 className="mb-0" id="headingTwo">
          <button
            ...
            }group  flex w-full items-center e border-0  px-5 py-4 text-left text-base transition rounded-md `}
            type="button"
            data-te-collapse-init
        ...
        <div
          ...
          data-te-parent="#accordionExample"
        >
          <div className="px-0 md:px-5 py-4 text-sm">
          ...
          <button
            className={` ${
              isActive.number3
                ? "bg-gradient-to-r from-indigo-300 via-purple-300 to-purple-100 text-gray-100   "
                : "bg-white text-neutral-800"
            }group  flex w-full items-center  px-5 py-4 text-left text-base transition rounded-md `}
            type="button"
            data-te-collapse-init
            data-te-collapse-collapsed
          ...
          <button
            className={` ${
              isActive.number4
                ? "bg-gradient-to-r from-indigo-300 via-purple-300 to-purple-100 text-gray-100   "
                : "bg-white text-neutral-800"
            }group  flex w-full items-center rounded-md  px-5 py-4 text-left text-base transition `}
            type="button"
            data-te-collapse-init
            data-te-collapse-collapsed
