    ...
    <div>
      ...
      <section className="mt-10">
        <p className="text-sm text-gray-500">
          ...
          อาทิตย์ หลังจากคอนเฟิร์มแบบแล้วใช้เวลาพัฒนาเว็บไซต์อีก 2 อาทิตย์
          สามารถแก้งานออกแบบ และงานทำเว็บไซต์ได้ อย่างละ 2 ครั้ง รวมแล้ว 4 ครั้ง
          หากมีการแก้ไขอื่นๆ ที่ไม่ใช่ Layout
      ...
      <section className="flex flex-col lg:flex-row gap-4 py-8 mt-14  ">
        ...
        <div className="w-full">
          ...
          <p className="mt-4 text-sm text-gray-600 leading-normal">
            ...
            และปรับเพิ่มความเร็วเว็บไซต์บริษัท ซึ่งเป็นปัจจัยสำคัญที่ Google
      ...
      <section className="flex flex-col lg:flex-row gap-4 py-8 mt-14  ">
        <div className="w-full">
          ...
          <p className="mt-4 text-sm text-gray-600 leading-normal">
            ...
            แม้จะมีต้นทุนที่ต่ำ
            การเลือกใช้บริการจากผู้เชี่ยวชาญที่มีประสบการณ์จะช่วยให้คุณได้เว็บไซต์สำเร็จรูปที่ตอบโจทย์ความต้องการของธุรกิจ
          </p>
        </div>
      ...
      <section className="py-8 mt-8">
        ...
        <p className="mt-4 text-sm text-gray-600 leading-normal">
          ...
          ไม่ว่าคุณจะต้องการ ออกแบบหน้าเว็บไซต์สำเร็จรูป, รับทำเว็บแบบ Custom,
          รับทำเว็บบริษัท, หรือ รับทำเว็บ e-commerce เว็บไซต์ขายของ
          การเลือกใช้บริการจากผู้เชี่ยวชาญจะช่วยให้คุณได้เว็บไซต์สำเร็จรูปที่มีประสิทธิภาพและพร้อมที่จะเติบโตในโลกออนไลน์ได้อย่าางสงบูนณ์แบบ
        </p>
      </section>
    </div>
  );
